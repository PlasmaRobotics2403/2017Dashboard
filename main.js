...
if (process.platform === 'win32') {
	...
	server = require('child_process').spawn('py', ['-3', '-m', 'pynetworktables2js', '--robot','10.24.3.2']);
} else {
	...
	server = require('child_process').spawn('python', ['-m', 'pynetworktables2js', '--robot','10.24.3.2']);
}
